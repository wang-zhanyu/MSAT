...
# Data directory
__C.DATA_LOADER.DATA_TYPE = 'vatex'

__C.DATA_LOADER.NUM_WORKERS = 4

__C.DATA_LOADER.N_GPU = 8
...
__C.DATA_LOADER.TRAIN_JSON_PATH = ''

__C.DATA_LOADER.TEST_JSON_PATH = ''

__C.DATA_LOADER.VAL_JSON_PATH = ''

# __C.DATA_LOADER.PRIVATE_JSON_PATH = './data/vatex/vatex_en_c_test_private_release.jsonl'
__C.DATA_LOADER.PRIVATE_JSON_PATH = './VALUE-challenge/ann/tvc/tvc_test_release.jsonl'
__C.DATA_LOADER.PRIVATE_HAVE_JSON_PATH = './VALUE-challenge/ann/vatex_en_c/vatex_en_c_test_private_have.jsonl'
__C.DATA_LOADER.PRIVATE_LOST_JSON_PATH = './VALUE-challenge/ann/vatex_en_c/vatex_en_c_test_private_loss.jsonl'
...
__C.DATA_LOADER.SAMPLE = False

__C.DATA_LOADER.SUBTITLES_PATH = None
__C.DATA_LOADER.TSN = False
__C.DATA_LOADER.GV_LOAD = 'first'
__C.DATA_LOADER.MORE_TVC_FRAMES = False

__C.DATA_LOADER.MLC_LABEL_PATH = None
...
__C.MODEL.SPEECH_TYPE = 'normal'

__C.MODEL.CNN_LAYER = 2

__C.MODEL.CLS_VOCAB_SIZE = 10

__C.MODEL.ENABLE_CLS = False
...
__C.MODEL.FUSION = False
__C.MODEL.USE_MOE = False
__C.MODEL.USE_MEMORY = False
__C.MODEL.USE_MEMORY_V2 = False
__C.MODEL.USE_MLC = True
__C.MODEL.USE_RELU = False
__C.MODEL.USE_GRU_GATE = False
__C.MODEL.MLC_WEIGHT = 5
__C.MODEL.MEMORY_DIM = 3
...
__C.SOLVER.LR_POLICY.PLATEAU_PATIENCE = 5
...
__C.PARAM.SUB_SEQ = 'SUB_SEQ'

__C.PARAM.TOKEN_TYPE_IDS = 'TOKEN_TYPE_IDS'

__C.PARAM.MLC_LABEL = 'MLC_LABEL'
# ---------------------------------------------------------------------------- #
# Inference options
# ---------------------------------------------------------------------------- #
__C.INFERENCE = edict()
